...
import com.application.foodnoculars.Adapter.StepAdapter;
import com.application.foodnoculars.DirectionsModel.LegModel;
import com.application.foodnoculars.DirectionsModel.ResponseModel;
import com.application.foodnoculars.DirectionsModel.RouteModel;
import com.application.foodnoculars.DirectionsModel.StepModel;
import com.application.foodnoculars.Webservice.RetrofitAPI;
import com.application.foodnoculars.Webservice.RetrofitClient;
import com.application.foodnoculars.databinding.ActivityDirectionsBinding;
import com.application.foodnoculars.databinding.DirectionsSheetBottomBinding;
...
public class Directions extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private DirectionsSheetBottomBinding bottomSheetLayoutBinding;
    ...
    private void getDirection(String mode) {
        ...
        if (isLocationPermissionOk)
        {
            ...
            retrofitAPI.getDirection(url).enqueue(new Callback<ResponseModel>() {
                @Override
                    ...
                    if (response.errorBody() == null) {
                        if (response.body() != null) {
                            ...
                            if (response.body().getDirectionRouteModels().size() > 0) {
                                RouteModel routeModel = response.body().getDirectionRouteModels().get(0);

                                //getSupportActionBar().setTitle(routeModel.getSummary());

                                LegModel legModel = routeModel.getLegs().get(0);
                                ...
                                for (StepModel stepModel : legModel.getSteps()) {
                                ...
                                Toast.makeText(Directions.this, "No route find", Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            Toast.makeText(Directions.this, "No route find", Toast.LENGTH_SHORT).show();
                        }
        ...
        if (appPermissions.isLocationOk(this)) {
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.ACCESS_FINE_LOCATION)) {
                new AlertDialog.Builder(this)
                        ...
                        .setMessage("Allow location permission to display you near by places?")
        ...
        fusedLocationProviderClient.getLastLocation().addOnSuccessListener(new OnSuccessListener<Location>() {
            ...
            public void onSuccess(Location location) {
                if (location != null) {
                    ...
                    Toast.makeText(Directions.this, "Location Not Found", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
