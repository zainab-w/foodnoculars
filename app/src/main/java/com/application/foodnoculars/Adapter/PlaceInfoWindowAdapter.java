...
import com.application.foodnoculars.databinding.PlaceInfoWindowBinding;
...
public class PlaceInfoWindowAdapter implements GoogleMap.InfoWindowAdapter {
    ...
    private PlaceInfoWindowBinding binding;
    private Location location;
    private Context context;

    public PlaceInfoWindowAdapter(Location location, Context context) {

        this.location = location;
        this.context = context;

        binding = PlaceInfoWindowBinding.inflate(LayoutInflater.from(context), null, false);
    }
