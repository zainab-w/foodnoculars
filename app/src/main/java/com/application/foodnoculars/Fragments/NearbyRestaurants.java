...
import com.application.foodnoculars.Adapter.GooglePlaceAdapter;
import com.application.foodnoculars.Adapter.PlaceInfoWindowAdapter;
import com.application.foodnoculars.AllConstant;
import com.application.foodnoculars.AppPermissions;
...
import com.application.foodnoculars.databinding.FragmentNearbyRestaurantsBinding;
        ...
        binding.enableTraffic.setOnClickListener(view -> {
            ...
            if (isTrafficEnable) {
                if (mGoogleMap != null) {
                    ...
                    trafficReference.setValue("false");
                }
            } else {
                if (mGoogleMap != null) {
                    mGoogleMap.setTrafficEnabled(true);
                    isTrafficEnable = true;
                    trafficReference.setValue("true");
                }
            }
